...
class OverlayCrossArray(pya.PCellDeclarationHelper):
    """
    The PCell declaration for the OverlayCrossArray
    """

    def __init__(self):

        # Important: initialize the super class
        super(OverlayCrossArray, self).__init__()
    ...
    def display_text_impl(self):
        ...
        return "OverlayCrossArray(L=%s)" % (str(self.l))
